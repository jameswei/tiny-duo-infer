...
|---|---|---|---|---|---|---|---|
| P1.7-T00 | Planning | Phase 1.7 source-of-truth docs | Phase 1.6 complete | review | codex | spec and taskboard exist; scope is observability plus per-request context-budget accounting; review confirms phase boundaries | ready for review; docs added by codex; no code tests required beyond markdown/diff check |
| P1.7-T01 | Metrics model | Generation stats types and KV memory formula | P1.7-T00 | todo | unassigned | stats type exists; KV allocated/active bytes are tested | |
