...
| P1.6-T01 | Request UX | Generation request/response types | P1.6-T00 | todo | unassigned | request validation and response metadata tests pass |  |
| P1.6-T02 | Request UX | Stop conditions and token accounting | P1.6-T01 | todo | unassigned | EOS, max-token, stop-string, and context-limit stops are tested |  |
| P1.6-T03 | Sampling UX | Seeded sampling support | P1.6-T01 | todo | unassigned | deterministic seed behavior is supported or explicitly documented if limited by MLX |  |
| P1.6-T04 | Prompt UX | Chat prompt formatting | P1.6-T01 | todo | unassigned | Qwen3 chat-style prompt formatting works without runtime `transformers` |  |
| P1.6-T05 | CLI UX | Refined CLI flags and stats | P1.6-T02, P1.6-T03, P1.6-T04 | todo | unassigned | CLI supports chat, stop strings, seed, and stats with tests |  |
